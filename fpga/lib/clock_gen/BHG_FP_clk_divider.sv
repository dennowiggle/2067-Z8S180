...
// WTM : Yosys can't print -ve numbers corrctly so remove the sign to prevent -ve number errors.
...
$display("  XXX   True output freq    = %0d.%02d Hz.",        (clk_tru_hzX100/100), ( clk_tru_hzX100 % 100 ) );
$display("  XXX   Frequency error     = %0d.%02d Hz.",        (clk_dif_hzX100/100), ( clk_dif_hzX100 % 100 ) );
$display("  XXX   Frequency error     = %0d.%02d ppm.",       (clk_ppm_x100/100),   ( clk_ppm_x100 % 100   ) );
$display("  XXX   Periodic jitter     = +/- %0d.%02d ns.",    (clk_jitterx100/100), ( clk_jitterx100 % 100 ) );
$display("  XXX   ---------------------------------------------");
...
$display("  XXX   ~Divider to 6dp     = %0d.%06d."                                                            , clk_per_int, $rtoi(1e6*f_div/65536));
$display("  XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
$display("");
end
endgenerate
